# Algemene Plaatselijke Verordening Legacy

## Wetstechnische informatie

### Wet van 16 juli 2025

Wij, de Beheersleden der Legacy, bij de gratie Gods, enz., enz., enz.

Aangezien wij in overweging hebben genomen dat het noodzakelijk is een nieuwe **Algemene Plaatselijke Verordening Legacy (APV)** vast te stellen:

| **Kenmerk**                | **Details**                          |
|----------------------------|--------------------------------------|
| Overheidsorganisatie       | Staff der Legacy                |
| Officiële naam regeling    | Algemene Plaatselijke Verordening Legacy |
| Citeertitel                | Algemene Plaatselijke Verordening Legacy |
...
Het Wetboek van Strafrecht, specifiek bedoeld voor Legacy, wordt hierbij overschreven door deze APV.
...
1. Deze Algemene Plaatselijke Verordening, hierna te noemen **APV**, is bedoeld als aanvulling op het Nederlands Recht en heeft betrekking op het eiland, de gemeente en de stad Legacy.
...
2. Het is niet toegestaan externe discords te gebruiken voor roleplay-gerelateerde zaken zonder toestemming van de staff.
    ...
    * Tijdens voicechats met andere spelers van Legacy geldt:
    ...
    * In calls zitten met je vrienden die geen Legacy spelen is ook verboden.
...
4. Officiële Legacy-kleding, bedoeld voor specifieke groeperingen, mag niet door anderen worden gebruikt of als startkleding worden gekozen, tenzij er een sterke en goedgekeurde roleplay aan verbonden is.
5. Kleding die aangekocht is via de Legacy website mag wel gedragen worden door iedereen. (Op eigen risico)
...
1. De voertalen op Legacy zijn **Nederlands** en **Engels**.
...
1. Het gebruik van beledigingen met betrekking tot relevante/hedendaagse ziektes, racistische of ongepaste opmerkingen is verboden op alle door Legacy erkende platformen.
...
4. Alle overeenkomsten met betrekking tot loodsen moeten schriftelijk worden vastgelegd en gedocumenteerd in de stad Legacy met het commando /docu, en dienen te worden ondertekend door alle betrokken partijen.
...
---
APV opgesteld uit naam van de beheersleden, bedoeld voor het eiland, de gemeente en de stad Legacy, opgetekend door Pino Pistool - pistool.exe, te Legacy.
