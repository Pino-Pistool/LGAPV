...
| | |
|---|---|
| Overheidsorganisatie      | Hoge Raad Legacy |
| Officiële naam            | Algemeen Wetboek Legacy |
| Citeertitel               | Wetboek Legacy |
...
1. Het Wetboek Legacy (verder aangeduid als WTDA) is leidend voor alle beschreven gevallen, waarbij als aanvulling het Nederlands Recht van toepassing is.
2. Het WTDA heeft betrekking op het vaste land, de gemeente, en de stad Legacy.
3. Het WTDA is nauw verweven met de Algemene Plaatselijke Verordening Legacy (APV). De APV dient echter als een indicerend kader voor eventuele bestraffing in-game (“in RP”) en is verder bedoeld voor het afhandelen van straffen buiten de RP om.
...
3. Minderjarigen worden binnen Legacy op dezelfde manier behandeld als volwassenen. Alle bepalingen, straffen en dergelijke zijn ook van toepassing op hen. Minderjarigen hebben dezelfde rechten en plichten als volwassenen. Het jeugdstrafrecht is in Legacy niet van toepassing.
...
3. Geldige redenen voor inbeslagname zijn:
    1. Plegen van een strafbaar feit uit het wetboek van Legacy waarbij het goed direct of indirect betrokken is, met uitzondering van fout parkeren en snelheidsovertredingen zoals beschreven in lid 4;  
...
![Titel VII](img/wetboek/Uitsluiting.webp)
...
---------------------
*Wetboek Legacy is opgesteld uit naam van de Hoge Raad, bedoeld voor de gemeente en de stad Legacy, opgetekend door Pino Pistool - pistool.exe, te Legacy.*
